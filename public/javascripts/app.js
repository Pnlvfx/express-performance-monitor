...
*/
/* global Chart, location, document, port, socketPath, io */
...
var statusCodesChart = new Chart(statusCodesChartCtx, {
  ...
  data: {
    labels: [],
    datasets: [Object.create(defaultDataset), Object.create(defaultDataset), Object.create(defaultDataset), Object.create(defaultDataset)],
  },
  options: defaultOptions,
});
