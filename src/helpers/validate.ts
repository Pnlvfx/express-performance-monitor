import { ChartVisibility, ExpressStatusConfig, ValidExpressStatusConfig } from '../types/config';
...
export const validate = (config?: ExpressStatusConfig): ValidExpressStatusConfig => {
  if (!config) {
